...
AI に HTML を作ってもらうようになって、人間が読むための HTML を作るコストはかなり下がりました。
PR の変更概要や動作確認の結果も、Markdown のコメントに詰め込むより、HTML にまとめた方が見やすいと感じています(個人の感想)。

ただ、せっかく HTML を作っても、見るまでに zip のダウンロードや展開が必要だと、なかなか開いてもらえません。HTML をどう作るかだけでなく、どうすれば手軽に見てもらえるかも同じくらい大事でした。

その点、GitHub Actions の Artifact は、CI からアップロードできて、そのまま PR に URL を貼れます。アクセス制御もリポジトリの権限に寄せられ、用が済んだら自動で消えてくれる。今回のような、一時的な HTML レポートの共有先としてちょうどよかったです。

新しい機能や技術もうまく取り入れながら、これからも認知負荷を下げ、面倒な作業を少しずつ減らしていきたいですね。
