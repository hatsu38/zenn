...
| 第6章 | 計画の木を、行が上へ進む | [SVG](sources/02-execution-tree.svg) | [PNG](02-execution-tree.png) |
| 第4章 | 索引から、表の行へたどる | [SVG](sources/03-index-reference.svg) | [PNG](03-index-reference.png) |
...
| 第5章 | 同じページを、別の接続でも使える | [SVG](sources/shared-buffer-reuse.svg) | [PNG](shared-buffer-reuse.png) |
...
| 第3章 | 境界を比べて、読むページを絞る | [SVG](sources/06-btree-path.svg) | [PNG](06-btree-path.png) |
