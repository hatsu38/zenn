...
\echo CHAPTER 6 ADDITION
EXPLAIN (ANALYZE, BUFFERS) SELECT id,title FROM books ORDER BY title LIMIT 3;
...
\echo RESTART PREPARATION CHECKS
...
SELECT count(*) AS books FROM public.books; SELECT count(*) AS reading_records FROM public.reading_records;