...
ここまでは、1冊を探す短い計画を読んできました。では、序章のランキングSQLの計画を出すとどうなるでしょうか。実際に出してみると、20行を超える出力になり、まだ知らない処理の名前が並びます。次章では、その長い計画をどこから読めばよいかを確かめ、この章の図の共有バッファと作業領域が、計画のどこに現れるかも読みます。
