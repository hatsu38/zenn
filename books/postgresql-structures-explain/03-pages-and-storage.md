...
![本の一覧は、どこに保存される？](/images/postgresql-structures-explain/03-storage-question.png)
*学ぶきっかけを描く、説明用の場面。*
...
![表の中にページ、ページの中に行](/images/postgresql-structures-explain/03-pages-and-rows.png)
...
![同じ1,000行でも、8ページと32ページ](/images/postgresql-structures-explain/03-row-width.png)
...
![索引から、表の行へたどる](/images/postgresql-structures-explain/03-index-reference.png)
*参照関係の模型 ／ ページ番号は省略。*
