...
![本の番号だけでは、題名が分からない](/images/postgresql-structures-explain/09-title-lookup.png)
*学ぶきっかけを描く、説明用の場面。*
...
![記録を1件取り出すたびに、本を探す](/images/postgresql-structures-explain/09-nested-loop.png)
...
![先に分類し、同じ箱の中で照合する](/images/postgresql-structures-explain/09-hash-join.png)
...
![並んだ二つの入力を、先頭から合わせる](/images/postgresql-structures-explain/09-merge-join.png)
