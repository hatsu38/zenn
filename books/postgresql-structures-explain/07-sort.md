...
![読み終えた順に、並べたい](/images/postgresql-structures-explain/07-recent-records.png)
*学ぶきっかけを描く、説明用の場面。*
...
![二つの並びを、比べながら合流する](/images/postgresql-structures-explain/07-merge-cards.png)
...
`INSERT 0 2000000`は200万行を追加したという出力です。続く`count(*)`でも、表全体が200万行になったことを確認できました。
...
![メモリに収まらないときの並べ替え](/images/postgresql-structures-explain/07-external-sort.png)
