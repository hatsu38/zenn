...
![索引があるのに、なぜ使わない？](/images/postgresql-structures-explain/10-planner-choice.png)
*学ぶきっかけを描く、説明用の場面。*
...
![同じ「1種類」でも、9,000行と1,000行](/images/postgresql-structures-explain/10-selectivity.png)
...
![入口の見積もりが、後ろの判断に響く](/images/postgresql-structures-explain/10-estimate-propagation.png)
