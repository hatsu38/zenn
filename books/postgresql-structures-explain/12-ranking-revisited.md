...
![今度は、根拠を持って選べる](/images/postgresql-structures-explain/12-decision-notebook.png)
*学ぶきっかけを描く、説明用の場面。*
...
![題名を付けてから、上位を選ぶ](/images/postgresql-structures-explain/12-ranking-before.png)
...
![上位を選んでから題名を付ける](/images/postgresql-structures-explain/12-ranking-after.png)
*6記録・3冊から上位2冊の模型 ／ 本文では上位20冊。*
...
![表示は軽くなる。集計の更新は必要。](/images/postgresql-structures-explain/12-preaggregation.png)
