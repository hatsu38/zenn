...
![画面の向こうで、SQLが動く](/images/postgresql-structures-explain/02-client-scene.png)
*学ぶきっかけを描く、説明用の場面。*
...
![接続ごとにプロセスが動く](/images/postgresql-structures-explain/02-connections.png)
...
![計画の木を、行が上へ進む](/images/postgresql-structures-explain/02-execution-tree.png)
*数字の小さい順に3件返す模型 ／ 本文の題名順と対応。*
